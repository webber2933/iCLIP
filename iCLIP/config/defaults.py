...
_C.MODEL.ICLIP_STRUCTURE = CN()
_C.MODEL.ICLIP_STRUCTURE.ACTIVE = False
_C.MODEL.ICLIP_STRUCTURE.STRUCTURE = "serial"
_C.MODEL.ICLIP_STRUCTURE.MAX_PER_SEC = 5
_C.MODEL.ICLIP_STRUCTURE.MAX_PERSON = 25
_C.MODEL.ICLIP_STRUCTURE.MAX_KEYPOINTS = 25
_C.MODEL.ICLIP_STRUCTURE.DIM_IN = 2304
_C.MODEL.ICLIP_STRUCTURE.DIM_INNER = 512
_C.MODEL.ICLIP_STRUCTURE.DIM_OUT = 512
_C.MODEL.ICLIP_STRUCTURE.PENALTY = True
_C.MODEL.ICLIP_STRUCTURE.LENGTH = (30, 30)
_C.MODEL.ICLIP_STRUCTURE.MEMORY_RATE = 1
_C.MODEL.ICLIP_STRUCTURE.CONV_INIT_STD = 0.01
_C.MODEL.ICLIP_STRUCTURE.DROPOUT = 0.
_C.MODEL.ICLIP_STRUCTURE.NO_BIAS = False
_C.MODEL.ICLIP_STRUCTURE.I_BLOCK_LIST = ['P', 'O', 'H', 'M', 'P', 'O', 'H', 'M']
_C.MODEL.ICLIP_STRUCTURE.LAYER_NORM = False
_C.MODEL.ICLIP_STRUCTURE.TEMPORAL_POSITION = True
_C.MODEL.ICLIP_STRUCTURE.ROI_DIM_REDUCE = True
_C.MODEL.ICLIP_STRUCTURE.USE_ZERO_INIT_CONV = True
_C.MODEL.ICLIP_STRUCTURE.MAX_OBJECT = 0
