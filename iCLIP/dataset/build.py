...
from iCLIP.utils.comm import get_world_size
from iCLIP.utils.IA_helper import has_object
import iCLIP.config.paths_catalog as paths_catalog
    ...
    for dataset_name in dataset_list:
        ...
        if data["factory"] == "DatasetEngine":
            ...
            if not is_train:
                ...
                args["box_file"] = None
            if has_object(cfg.MODEL.ICLIP_STRUCTURE):
