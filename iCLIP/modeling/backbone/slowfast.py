...
from iCLIP.modeling.common_blocks import ResNLBlock
from iCLIP.layers import FrozenBatchNorm3d

# from iCLIP.external_attention.attention.CBAM import CBAMBlock
...
class FastPath(nn.Module):
    def __init__(self, cfg):
        ...
        # 
        # self.FastCBAM = CBAMBlock(channel=256,reduction=16,kernel_size=8, attention='fast')
    ...
    def forward(self, x):
        ...
        # print("Fast ", out.shape)
        # out = self.FastCBAM(out)
...
class SlowPath(nn.Module):
    def __init__(self, cfg):
        ...
        # self.SlowCBAM = CBAMBlock(channel=2048,reduction=16,kernel_size=8, attention='slow')
    ...
    def forward(self, x, lateral_connection=None):
        ...
        out = self.res_nl4(out)
        # print("slow ", out.shape)
        # out = self.SlowCBAM(out)
        return out
