import torch
from iCLIP.layers import SigmoidFocalLoss, SoftmaxFocalLoss
from iCLIP.modeling.utils import cat
...
class ActionLossComputation(object):
    ...
    def __call__(self, class_logits, avg_box_num):
        ...
        # print(class_logits.shape[1], self.num_pose + self.num_object + self.num_person)
