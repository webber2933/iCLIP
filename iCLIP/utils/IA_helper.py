...
def has_hand(ia_config):
    ia_blocks = _block_set(ia_config.I_BLOCK_LIST)
    return (ia_config.ACTIVE and 'H' in ia_blocks and ia_config.MAX_KEYPOINTS > 0)

def has_pose(ia_config):
    ia_blocks = _block_set(ia_config.I_BLOCK_LIST)
    return (ia_config.ACTIVE and 'POSE' in ia_blocks and ia_config.MAX_KEYPOINTS > 0)
